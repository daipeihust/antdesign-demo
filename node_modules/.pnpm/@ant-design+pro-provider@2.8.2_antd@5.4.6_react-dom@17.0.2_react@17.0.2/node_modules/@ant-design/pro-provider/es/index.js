...
var ConfigProviderContainer = function ConfigProviderContainer(props) {
  ...
  var hashId = useMemo(function () {
    var _process, _process$env$NODE_ENV;
    if (props.hashed === false) {
      return '';
    }
    if (proProvide.hashed === false) return '';
    if (((_process = process) === null || _process === void 0 ? void 0 : (_process$env$NODE_ENV = _process.env.NODE_ENV) === null || _process$env$NODE_ENV === void 0 ? void 0 : _process$env$NODE_ENV.toLowerCase()) !== 'test') return nativeHashId;
    return '';
